    ...
    return (
        <div>
            <Switch>
                ...
                <Route path="/headphones/headphones-store" exact render={() => <ElectronicStore/>} />
                <Route path="/laptop/laptop-store" exact render={() => <FashionStore/>} />
                <Route path="/TV screen/TV screen-store" exact render={() => <ApplianceStore/>} />
            </Switch>
        </div>
    );
}
